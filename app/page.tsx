			...
			<div className="container mx-auto px-4 py-16">
				<div className="max-w-4xl mx-auto">
					<div className="text-center mb-16">
						<h1 className="text-5xl font-bold text-gray-900 dark:text-white mb-4">llmchat</h1>
						<p className="text-xl text-gray-600 dark:text-gray-300">上传文档，智能问答，快速获取知识</p>
					</div>
					...
					<div className="grid md:grid-cols-2 gap-8">
						<Link href="/upload">
							<div className="bg-white dark:bg-gray-800 rounded-xl shadow-lg p-8 hover:shadow-xl transition-shadow cursor-pointer border-2 border-transparent hover:border-indigo-500">
								...
								<h2 className="text-2xl font-semibold text-gray-800 dark:text-white mb-2">文档上传</h2>
								<p className="text-gray-600 dark:text-gray-400">上传您的文档文件，构建知识库</p>
							</div>
						</Link>
						...
						<Link href="/qa">
							<div className="bg-white dark:bg-gray-800 rounded-xl shadow-lg p-8 hover:shadow-xl transition-shadow cursor-pointer border-2 border-transparent hover:border-purple-500">
								...
								<h2 className="text-2xl font-semibold text-gray-800 dark:text-white mb-2">智能问答</h2>
								<p className="text-gray-600 dark:text-gray-400">基于知识库进行智能问答</p>
							</div>
						</Link>
					</div>

					<div className="mt-16 bg-white dark:bg-gray-800 rounded-xl shadow-lg p-8">
						<h3 className="text-xl font-semibold text-gray-800 dark:text-white mb-4">功能特点</h3>
						<ul className="space-y-3">
							<li className="flex items-start">
								<svg className="w-6 h-6 text-green-500 mr-3 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
									<path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7" />
								</svg>
								<span className="text-gray-700 dark:text-gray-300">支持多种文档格式上传（TXT, PDF, DOC, DOCX, MD）</span>
							</li>
							<li className="flex items-start">
								<svg className="w-6 h-6 text-green-500 mr-3 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
									<path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7" />
								</svg>
								<span className="text-gray-700 dark:text-gray-300">智能文档检索，快速定位相关内容</span>
							</li>
							<li className="flex items-start">
								<svg className="w-6 h-6 text-green-500 mr-3 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
									<path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7" />
								</svg>
								<span className="text-gray-700 dark:text-gray-300">基于AI的智能问答，准确理解您的问题</span>
							</li>
						</ul>
					</div>
				</div>
